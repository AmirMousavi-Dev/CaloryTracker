package ir.codroid.tracker_data.repository

import ir.codroid.tracker_data.local.TrackerDao
import ir.codroid.tracker_data.mapper.toTrackableFood
import ir.codroid.tracker_data.mapper.toTrackedFood
import ir.codroid.tracker_data.mapper.toTrackedFoodEntity
            ...
            Result.success(
                searchDto.products
                    .filter {
                        ...
                        calculatedCalories in (lowerBound..upperBound)
                    }
